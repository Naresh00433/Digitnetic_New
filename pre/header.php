        ...
        <div class="container py-3">
            <div class="d-flex align-items-center">
                ...
                <div class="ms-auto d-none d-lg-block">
                        <a href="contact" class="btn btn-primary bg-light text-primary rounded-pill py-2 px-3">Get A Quote</a>
                </div>
            </div>
        </div>
    </div> -->
    ...
    <div class="container-fluid bg-white sticky-top shadow-sm">
        <div class="container">
            <nav class="navbar navbar-expand-lg bg-white navbar-light p-lg-0 ">
                <a href="index" class="d-flex align-items-center">
                    <img src="img/logo.png" alt="Digitnetic Logo" style="height:60px; width:auto; margin-right:10px;">
                </a>

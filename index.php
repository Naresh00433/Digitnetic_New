                            ...
                            <div class="row justify-content-start">
                                <div class="col-lg-7 text-start">
                                    <p class="fs-4 text-white animated slideInRight">Welcome to
                                        <strong class="text-primary">Digitnetic</strong>
                                    </p>
            ...
            <div class="row g-0 feature-row text-center">
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.1s">
                    <div class="feature-item border h-100 p-5">
                        <h5 class="mb-3 text-primary">Affiliate Program Management</h5>
                        <p class="mb-0">Comprehensive affiliate program management for seamless success.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.3s">
                    <div class="feature-item border h-100 p-5">
                        <h5 class="mb-3 text-primary">Performance Tracking and Analytics</h5>
                        <p class="mb-0">Track, analyze, and optimize affiliate marketing success.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.5s">
                    <div class="feature-item border h-100 p-5">
                        <h5 class="mb-3 text-primary">Customized Affiliate Campaigns</h5>
                        <p class="mb-0">Personalized campaigns drive traffic and boost earnings.</p>
                    </div>
                </div>
            </div>
        </div>
